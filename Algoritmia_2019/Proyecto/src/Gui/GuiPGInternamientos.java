...
public class GuiPGInternamientos extends JFrame implements ActionListener, ItemListener {
	...
	public GuiPGInternamientos() {
		...
		CboAño.setMaximumRowCount(6);
		CboAño.setFont(new Font("Tahoma", Font.PLAIN, 12));
		CboAño.setBounds(290, 33, 56, 20);
		...
		Libreria.colocarAñoActual(CboAño);
