...
public class Libreria {
	...
	public static void GenerarAños(JComboBox<String>cbo){
		for (int i = AñoActual()-3; i < AñoActual()+6; i++) {
			cbo.addItem(""+i);
		}
	}
	...
	public static void colocarAñoActual(JComboBox<String>cbo){
		String año= ""+AñoActual();
		cbo.setSelectedItem(año);
	}
	...
	public static String obtenerFecha(JComboBox<String> dd,JComboBox<String> mm,JComboBox<String> aa){
		int dia= dd.getSelectedIndex()+1,
			...
			año= Integer.parseInt(aa.getSelectedItem().toString());
		String fe= ""+((año*100+mes)*100+dia);
